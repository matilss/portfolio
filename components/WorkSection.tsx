...
const projects = [
  {
    ...
    image: "/images/homepage/cardpilot.png",
...
export default function WorkSection() {
  return (
    <div className="h-full w-full overflow-hidden">
      <div
        className="flex items-center h-full gap-8 overflow-x-auto cursor-grab active:cursor-grabbing pr-[7vw]"
      ...
      >
        {/* Title + description as first item */}
        <div className="flex-shrink-0 w-[38vw] pl-[7vw] pr-4">
          ...
          <p className="text-[#707070] text-[13px] md:text-[16px] leading-relaxed w-full">
        ...
        {projects.map((p, i) => (
          <a
            key={p.title}
            href={p.href}
            className={`relative flex-shrink-0 w-[80vw] md:w-[43vw] h-[75%] rounded-[32px] overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-500 group ${i === 0 ? "ml-10" : ""}`}
            draggable={false}
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-7">
              <h3 className="text-white font-semibold text-[24px] md:text-[26px] leading-snug tracking-tight mb-1">
                {p.title}
              </h3>
