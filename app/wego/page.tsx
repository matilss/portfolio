      ...
      <div className="px-4 md:px-[12vw] pb-32">
        ...
        <section id="research" className="py-10 md:py-20 scroll-mt-20">
          <SectionCard label="Research">
            ...
            {/* Affinity map */}
            <div className="mt-8 rounded-[20px] overflow-hidden md:max-w-[80%] md:mx-auto">
              <img
        ...
        {/* Scope */}
        <section id="scope" className="py-10 md:py-20 scroll-mt-20">
        ...
        {/* Final Product */}
        <section id="final-product" className="py-10 md:py-20 scroll-mt-20">
...
function SectionCard({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="rounded-[24px] pt-10 md:pt-16 px-5 md:px-10 pb-10" style={{ background: "#0d0d0d", border: "1px solid rgba(255,255,255,0.06)" }}>
